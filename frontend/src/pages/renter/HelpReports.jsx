...
export default function HelpReports() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMsg(
        "Report submitted successfully! The landlord will review it soon.",
      );
      setShowModal(false);
      setTitle("");
      setCategory("");
    ...
    switch (status?.toLowerCase()) {
      case "reviewed":
        return {
          ...
          icon: <FaEye className="text-info" size={20} />,
          text: "Reviewed",
        };
      case "resolved":
        return {
          badge: "bg-success-subtle text-success",
          icon: <FaCheckCircle className="text-success" size={20} />,
          text: "Resolved",
        };
      default:
        return {
          badge: "bg-warning-subtle text-warning",
          icon: <FaRegClock className="text-warning" size={20} />,
          text: "Pending",
        };
    }
  };
  ...
  if (user?.role !== "tenant") {
    return (
      <div
        className="p-4 bg-light min-vh-100 position-relative"
          ...
          <div className="col-md-8 mx-auto">
            <div className="card border-0 shadow-sm p-5 text-center">
              ...
              <p className="text-muted fs-5 mb-0">
                Help & Reports are only available for official tenants with an
                active lease. Please wait for your application to be approved.
              </p>
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                <div className="card-body p-3 p-md-4 d-flex align-items-center justify-content-between">
                  ...
                  <div>
                    <span
                      className={`badge rounded-pill px-3 py-2 ${style.badge}`}
                      style={{ fontSize: "12px" }}
                    >
                      {style.text}
                    </span>
        ...
        >
          ...
          >
            ...
            <p className="text-muted small mb-4">
              Describe the issue and select a category.
            </p>
