...
export default function LeaseInfo() {
  ...
  useEffect(() => {
    const fetchLeaseInfo = async () => {
      try {
        ...
        const res = await axios.get(`${API_URL}/api/leases/my/lease`, {
        ...
        setError(
          "You don't have an active lease contract yet, or it is still pending approval.",
        );
      } finally {
        setLoading(false);
      }
  ...
  if (loading) {
    return (
      <div className="p-5 text-center text-muted min-vh-100 d-flex align-items-center justify-content-center">
    ...
    >
      ...
      <div className="mb-4">
        ...
        <p className="text-muted small">
          View your active rental contract details and terms.
        </p>
      </div>
          ...
          <div className="col-lg-4">
            <div className="card border-0 shadow-sm rounded-4 mb-4">
              <div className="card-body p-4 text-center">
                ...
                <span
                  className={`badge rounded-pill px-4 py-2 mt-2 ${lease.status === "active" ? "bg-success" : "bg-warning text-dark"}`}
                >
              ...
              <div className="card-body p-4">
                  ...
                  <div>
                    ...
                    <strong className="d-block text-primary">
                      ...
                      {lease.rentAmount?.toLocaleString() ||
                        lease.unitId?.price?.toLocaleString() ||
                        "0"}
                    </strong>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <strong className="d-block">
                      Every {lease.paymentDueDay || "1st"} of the month
                    </strong>
                  </div>
                </div>
              </div>
          ...
          <div className="col-lg-8">
            <div className="card border-0 shadow-sm rounded-4 h-100">
              <div className="card-body p-4 p-md-5">
                ...
                <div
                  className="bg-secondary bg-opacity-10 p-4 rounded-3 text-muted small"
                  style={{ maxHeight: "200px", overflowY: "auto" }}
                >
                  <p className="mb-2">
                    <strong>1. Rent Payment:</strong> Rent is due on the
                    specified day of each month. Late payments may incur
                    additional fees as stated in the final contract.
                  </p>
                  <p className="mb-2">
                    <strong>2. Maintenance:</strong> The tenant is responsible
                    for reporting any damages or necessary repairs immediately
                    through the Maintenance portal.
                  </p>
                  <p className="mb-2">
                    <strong>3. Subleasing:</strong> Subleasing the unit to
                    another party is strictly prohibited without written consent
                    from the management.
                  </p>
                  <p className="mb-0">
                    <strong>4. Termination:</strong> Early termination of this
                    lease agreement requires a 30-day prior written notice and
                    may be subject to penalty fees.
                  </p>
